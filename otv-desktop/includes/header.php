...
<html>
<head>
	<title>Latest Odisha News, Breaking News Today | Top Updates on Corona - OTV News</title> 
...
<ul class="top-menu top-menu-right" style="position: absolute; top:25px; right: 7.5px;"><li class="top-social-btn"><a href="https://www.facebook.com/otvnews/" title="Facebook" target="_blank"><i class="fab fa-facebook-f"></i></a></li> 
        <li class="top-social-btn"><a href="https://twitter.com/otvnews" title="Twitter" target="_blank"><i class="fab fa-twitter"></i></a></li> 
        <li class="top-social-btn"><a href="https://www.instagram.com/otv.news" title="Instagram" target="_blank"><i class="fab fa-instagram"></i></a></li> 
        <li class="top-social-btn"><a href="https://www.linkedin.com/company/odishatv" title="LinkedIn" target="_blank"><i class="fab fa-linkedin-in"></i></a></li> 
        <li class="top-social-btn"><a href="https://t.me/otvtelegram" title="Telegram" target="_blank"><i class="fab fa-telegram-plane"></i></a></li> 
        <li class="top-social-btn"><a href="https://www.youtube.com/c/OTVNewsEnglish" title="Youtube" target="_blank"><i class="fab fa-youtube"></i></a></li> 
        <li class="read-in-odia"><a href="https://khabar.odishatv.in/" title="ଓଡ଼ିଆରେ ପଢନ୍ତୁ" target="_blank"><i class="fas fa-language" style="display:none"></i><img alt="otv" title="otv" src="https://odishatv.in//commondir/images/translate-icon.svg" width="35" height="17"></a></li> 
        <li><button id="login-odisha">login</button></li>
         </ul>
</div>
</div>
</div>
...
.day-tips ::-webkit-scrollbar-thumb:hover {
  ...
  <div class="container"style="float: left;width: 100%;">
      <div class="day-tips" style="text-align: center;position: relative;width: 929px;height: 158px;margin: 15px auto;display: block;">
          <img src="images/tips-bg-web.jpg" style="width: 929px;height: 158px;" alt="" title="">
          <p  style="position: absolute;top: 32px;left: 358px;padding: 5px 0px 10px 0px;margin: 0;font-size: 14px;color: #000000;font-weight: 600;height: 87px;overflow: auto;width: 546px;">Do you have plans to visit Kendrapara, if yes, then now you can catch glimpse of glorious history Do you have plans to visit Kendrapara, if yes, then now you can catch glimpse of glorious history Do you have plans to visit Kendrapara, if yes, then now you can catch glimpse of glorious history...</p>
      </div>
  </div>