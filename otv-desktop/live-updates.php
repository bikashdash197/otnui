   ...
   <div class="row">
      ...
      <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
         <div class="live-details-heading">
            ...
            <!--                  <div class="live-details-banner-video">
               <h4 class="live-details-banner-video-details">Track Cyclone Yaas Direction and Movements</h4>
               
               
               <iframe width="100%" height="450" src="https://embed.windy.com/embed2.html?lat=15.750&lon=85.825&detailLat=15.750&detailLon=85.825&width=650&height=450&zoom=5&level=surface&overlay=wind&product=ecmwf&menu=&message=true&marker=true&calendar=now&pressure=true&type=map&location=coordinates&detail=&metricWind=km%2Fh&metricTemp=%C2%B0C&radarRange=-1" frameborder="0"></iframe>
               
               
               <p class="live-details-banner-video-disclaimer"><span>Disclaimer:</span>Cyclone YAAS tracker embedded from Windy.com is only an approximate visualisation predicting the movements of the Cyclone based on open data. Windy.com's projections may vary from predictions by other weather agencies such as India Meteorological Department (IMD). For precision, referencing  updates from IMD or associated agencies/institutes is strongly recommended.</p>
               </div> -->
         </div>
         ...
         <div class="otv-728-90-ad">
            <!-- /370089190/Below_Featured_Image_Desktop_LivePage_728x90 -->
            <div id="div-gpt-ad-22469804781-0" style="width: 728px; height: 90px;" data-google-query-id="CI725LH07vMCFc2AZgIdZ1MIJg">
               <div id="google_ads_iframe_/370089190/Below_Featured_Image_Desktop_LivePage_728x90_0__container__" style="border: 0pt none;">
                  <iframe id="google_ads_iframe_/370089190/Below_Featured_Image_Desktop_LivePage_728x90_0" title="3rd party ad content" name="google_ads_iframe_/370089190/Below_Featured_Image_Desktop_LivePage_728x90_0" width="728" height="90" scrolling="no" marginwidth="0" marginheight="0" frameborder="0" sandbox="allow-forms allow-popups allow-popups-to-escape-sandbox allow-same-origin allow-scripts allow-top-navigation-by-user-activation" srcdoc="" style="border: 0px; vertical-align: bottom;" data-google-container-id="3" data-load-complete="true"></iframe>
               </div>
            </div>
         </div>
         <!--  <div class="otv-728-90-ad"><div id="div-gpt-ad-22345112743-0" style="width: 728px; height: 90px;"><script>googletag.cmd.push(function() { googletag.display("div-gpt-ad-22345112743-0"); }); </script></div></div> -->
