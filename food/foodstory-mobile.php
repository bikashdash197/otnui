...
<section class="food-story-mobile">
    <div class="container">
        <div class="food-content">
                    ...
                    <div class="food-author">
                        ...
                        </li><li><a href="#" onclick="javascript: window.print(); return false;"><img src="https://odishatv.in/commondir/images/svg/print-icon.svg" width="20" height="20" alt="Print" style="margin-right: 10px;"></a></li>
                        </ul>
                    </div>
